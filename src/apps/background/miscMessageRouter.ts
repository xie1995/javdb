...
import { handleFetchHtml, handleFetchImage } from '../../features/externalPreviews/backgroundHandlers';
import {
    ...
    chrome.runtime.onMessage.addListener((message: any, _sender, sendResponse): boolean | void => {
      ...
      switch (message.type) {
        ...
        case 'FETCH_EXTERNAL_COVER':
          ...
          return true;
        case 'FETCH_EXTERNAL_PREVIEWS_HTML':
          handleFetchHtml(message, sendResponse);
          return true;
        case 'FETCH_EXTERNAL_PREVIEWS_IMAGE':
