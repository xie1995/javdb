...
features:
  ...
  - title: 功能完整
    details: 覆盖视频标记、数据管理、WebDAV、115 v2 离线下载、演员订阅、磁力搜索、AI 翻译等能力。
  - title: 当前文档
    details: 保留一套持续维护中的当前文档，避免多版本分叉带来的维护成本。
  - title: 面向维护
...
- 配合 **115 v2 离线下载**、**磁力搜索**、**演员订阅** 提高整理效率
...
| 配置 115 离线下载 | [115 网盘集成](/guide/115-drive) |
